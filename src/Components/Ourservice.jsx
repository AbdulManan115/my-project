...
export default function Services() {
  return (
    <div className="services-background mt-15 rounded-br-[50px] lg:rounded-br-[150px] px-6 sm:px-12 py-10 sm:py-20">
      <div className="max-w-[700px] px-4 sm:px-6 lg:px-8 py-12 sm:py-16 bg-black/60 rounded-lg">
        ...
        <p className="text-base sm:text-lg lg:text-lg font-sans text-white/90 mb-10">
        ...
        <a
          href="/services"
          className="mt-2 bg-[#007BFF] hover:bg-white text-white hover:text-[#007BFF] font-semibold px-6 sm:px-8 py-2 sm:py-3 rounded-lg transition-all duration-300 border border-transparent hover:border-[#007BFF]"
        >
          View Our Services →
        </a>
      </div>
