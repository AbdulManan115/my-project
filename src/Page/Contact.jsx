...
import { Mail, ChevronDown, MapPin, Phone, PinIcon } from "lucide-react";
        ...
        <div className="relative flex items-center justify-center min-h-[70vh] sm:min-h-[80vh] md:min-h-screen px-3 sm:px-6 md:px-10 py-8 sm:py-12 md:py-16">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
              ...
              {/* 🔸 Left Side */}
              <div>
                <p className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif leading-tight text-left break-words">
                ...
                <div className="text-left mt-3 sm:mt-6">
                  ...
                  <ul className="space-y-3 text-white text-sm sm:text-base md:text-lg font-sans">
                    <li className="flex items-center gap-3">
                      ...
                      <a href="mailto:hello@calmkaaj.com" className="underline decoration-transparent hover:decoration-inherit">hello@calmkaaj.com</a>
                    </li>
                    <li className="flex items-center gap-3">
                      <Phone size={18} className="text-white" />
                      <div className="flex flex-col sm:flex-row gap-1 sm:gap-2">
                        <a href="tel:+923136224778" className="text-[17px] underline decoration-transparent hover:decoration-inherit">+92 313 6224778</a>
                        <span className="hidden sm:inline">|</span>
                        <a href="tel:+923231557988" className="text-[17px] underline decoration-transparent hover:decoration-inherit">+92 323 1557988</a>
                      </div>
                    </li>
                    <a href="/location" className="flex cursor-pointer items-center gap-3">
                      <MapPin size={18} className="text-white" />
                      <span>Barakahu Islamabad</span>
                    </a>
                    <a href="/location" className="flex items-start gap-3 cursor-pointer text-sm md:text-base">
              ...
              <div>
                <div className="grid grid-cols-1 gap-4 sm:gap-5 mt-6">
                  ...
                  <div className="border-2 border-white rounded-lg p-3 sm:p-4 relative">
                    ...
                    {openLocation && (
                      <ul className="absolute left-0 top-full mt-2 w-full max-h-60 overflow-auto bg-black hover:bg-blue-800  py-2  text-white rounded-lg z-10 text-sm sm:text-base">
                        {["DafterSpce : Barakhu Islamabad"].map((loc) => (
                          <a href="/location"
                            key={loc}
                            className="px-4 py-3  rounded-lg cursor-pointer block"
                          >
                            {loc}
                          </a>
                        ))}
                  ...
                  <div className="border-2 border-white rounded-lg p-3 sm:p-4 relative">
                    ...
                    {openWorkspace && (
                      <ul className="absolute left-0 top-full mt-2 w-full max-h-60 overflow-auto bg-black text-white rounded-lg z-10 text-sm sm:text-base">
                        {[
                          "Private Offices",
                          "Flexible Desk",
                          "Dedicated Desk",
                ...
                <div className="flex justify-start mt-6">
                  <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#27371B] hover:bg-white text-white hover:text-amber-500 font-semibold px-6 sm:px-10 py-2 sm:py-3 rounded-lg transition text-sm sm:text-base">
